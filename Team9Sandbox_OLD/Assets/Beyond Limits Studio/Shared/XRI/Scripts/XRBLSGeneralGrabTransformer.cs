...
{
    public class XRBLSGeneralGrabTransformer : XRBaseGrabTransformer
    {
        /// <summary>
        ...
        [SerializeField]
        private Transform piorityAttach;
        ...
        UnityEngine.XR.Interaction.Toolkit.Interactors.IXRInteractor m_OriginalInteractor;
        ...
        public override void OnGrab(UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable grabInteractable)
        {
            ...
            if (grabInteractable.interactorsSelecting.Count > 1 && piorityAttach != null && piorityAttach != grabInteractable.GetAttachTransform(interactor))
            {
                interactor = grabInteractable.interactorsSelecting[1];
            }
        ...
        /// <inheritdoc />
        public override void OnGrabCountChanged(UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable grabInteractable, Pose targetPose, Vector3 localScale)
        {
            ...
            else if (newGrabCount > 1)
            {
                ...
                if (piorityAttach != null && piorityAttach == grabAttachTransform1)
                {
                    interactor0 = grabInteractable.interactorsSelecting[1];
                    interactor1 = grabInteractable.interactorsSelecting[0];

                    grabAttachTransform1 = grabInteractable.GetAttachTransform(interactor1);
                }
        ...
        Pose ComputeAdjustedInteractorPose(UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable grabInteractable, out Vector3 newHandleBar)
        {
            ...
            if (grabInteractable.interactorsSelecting.Count > 1)
            {
                ...
                if (piorityAttach != null && piorityAttach != grabInteractable.GetAttachTransform(interactor0))
                {
                    interactor0 = grabInteractable.interactorsSelecting[1];
                    interactor1 = grabInteractable.interactorsSelecting[0];
                }
                ...
                Debug.DrawLine(interactor0Transform.position, interactor0Transform.position + interactor0Transform.TransformDirection(m_StartHandleBar * 0.25f), Color.red);
                Debug.DrawLine(interactor1Transform.position, interactor1Transform.position + interactor1Transform.TransformDirection(m_StartHandleBar * 0.25f), Color.blue);
        ...
        Vector3 ComputeNewScale(UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable grabInteractable, Vector3 startScale, Vector3 currentScale, Vector3 startHandleBar, Vector3 newHandleBar)
        {
        ...
        void UpdateTarget(UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable grabInteractable, ref Pose targetPose, ref Vector3 localScale)
        {
